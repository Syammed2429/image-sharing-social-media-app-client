...
const CreatePin = ({ user }) => {
    ...
    const uploadImage = (e) => {
        ...
        if (selectedFile.type === 'image/png' || selectedFile.type === 'image/svg' || selectedFile.type === 'image/jpeg' || selectedFile.type === 'image/gif' || selectedFile.type === 'image/tiff' || selectedFile.type === 'image/jpg' || selectedFile.type === 'image/apng' || selectedFile.type === 'image/avif' || selectedFile.type === 'image/webp' || selectedFile.type === 'image/bmp') {
